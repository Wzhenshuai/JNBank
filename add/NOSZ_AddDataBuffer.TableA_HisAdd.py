...
for ta in allTable:
    ...
    file_sql_name = " AddDataBuffer.%s_HisAdd.sql" % table_name
    ...
    create_table_str = create_table_str + "\rData_source_str varchar(33) COMMENT'数据来源'\r" \
                                          ")comment'%s汉语注解.增量历史表' partitioned by(partition_day varchar(33))  stored as ORC;"%(table_name)
