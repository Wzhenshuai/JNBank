...
allTempFilePath = r"E:\mnt\template\add\Core_agentShell\FullAddData.Core.SHORTNAME_tablename.sh"
...
for td in table_datas:
    ...
    for fd in field_datas:
        ...
        if fd[0].upper() == 'CORPORATION':
            field1 = "select "
    fieldStr = field1 + fieldStr.rstrip(',')+' from ${source_Table} where and \$CONDITIONS'
