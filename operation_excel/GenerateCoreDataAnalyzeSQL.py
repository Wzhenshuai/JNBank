...
def exec():
    numIndex = 0
    numIndex += 1
    header = "--- 本文件: AllDataAnalyze.Core.%s.sql \r CREATE DATABASE IF NOT EXISTS AllAnalyze COMMENT '全量.解析库';\r" % system_nu
    ...
    for td in table_datas:
        ...
        boday = "create external table IF NOT EXISTS Core_%s(\r" % tableName
